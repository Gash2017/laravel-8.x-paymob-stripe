            ...
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <div class="card-text">
                        ...
                        <a href="{{ route('cart.checkout', $cart->totalPrice)}}" class="btn btn-info">Checkout Stripe</a>
                        <a href="{{ route('cart.checkout1', $cart->totalPrice)}}" class="btn btn-info">Checkout PayMob</a>
                    </div>
                </div>
            </div>
        </div>
